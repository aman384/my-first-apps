...
export default class MyGroups extends Component {
    ...
    componentDidMount() {
        ...
        $('#li_my_groups').addClass('active');
        $('#li_my_groups').closest('.sidebar-submenu').show();
        $('#li_my_groups').closest('.sidebar-submenu').closest('.sidebar-dropdown').addClass('active');
        this.groupAPI()
    }
                                                ...
                                                <div className="central-meta">
                                                    <div className="frnds">
                                                        <ul className="nav nav-tabs">
                                                            <li className="nav-item"><a className="" href="#frends-req" data-toggle="tab">My Groups</a></li>
                                                        </ul>
