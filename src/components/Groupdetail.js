...
export default class Groupdetail extends Component {
    ...
    componentDidMount() {
        ...
        $("body").delegate(".m-hashtags__trending>li>a", "click", function () {
            ...
            if ($(".select_tag_area").children().length < 5) {
                $(".select_tag_area").append('<span className="select_tag"><b>' + input + '</b><i  className="fa fa-close"></i></span>');
            }
        })
    ...
    select_serach_tag(item) {
        if ($(".select_tag_area").children().length < 5) {
            $(".select_tag_area").append('<span className="select_tag"><b>' + item.hashtag + '</b><i  className="fa fa-close"></i></span>');
    ...
    replyOnComment = (id) => {
        $('#main_loader').show();
        $('#root').css('opacity', '0.5');
        if (this.state.image_file1 === '' && $('#message1' + id.post_id).val() === '') {
            return false;
        }
        let formData = new FormData();
    ...
    replyOnReplyComment = (id) => {
        $('#main_loader').show();
        $('#root').css('opacity', '0.5');
        if (this.state.image_file2 === '' && $('#message2' + id.post_comment_id).val() === '') {
            return false;
        }
    ...
    replyOnReplyCommentMessage = (id) => {
        $('#main_loader').show();
        $('#root').css('opacity', '0.5');
        if (this.state.image_file2 === '' && $('#message2Message' + id.chat_id).val() === '') {
            return false;
        }
                                                                ...
                                                                <div className="new-postbox">
                                                                    ...
                                                                    <div className="newpst-input">
                                                                        <form onSubmit={(this.state.detailPost != '') ? this.handleSubmitFile : this.handleSubmitFile}>
                                                                            <textarea rows="2" id="post_text" style={{ fontSize: '17px' }} value={this.state.message}
                                                                                onChange={this.onChange} name="message" placeholder="Write something"></textarea>
                                                                                                        ...
                                                                                                        <li className="post-comment" id={"reply_box" + item1.post_comment_id} style={{ display: 'none', marginLeft: '63px', marginTop: '10px' }}>
                                                                                                            ...
                                                                                                            <div className="post-comt-box" style={{ width: '77%' }}>
                                                                                                                <form className="main_msg_area1">
                                                                                                                    <textarea id={"message2" + item1.post_comment_id} placeholder="Post your comment"></textarea>
                                                                                        ...
                                                                                        <li className="post-comment">
                                                                                            ...
                                                                                            <div className="post-comt-box">
                                                                                                <form className="main_msg_area">
                                                                                                    <textarea id={"message1" + item.post_id} placeholder="Post your comment"></textarea>
                                                                                                    <div className="add-smiles">
                                                                                                        {/* <span className="em em-expressionless" title="add icon"> */}
                                                                                                        <i className="fa fa-picture-o post_commentcss" aria-hidden="true"></i> &nbsp;
                ...
                <div id="myModal3" className="modal fade" role="dialog">
                    <div className="modal-dialog modal-dialog2">
                        ...
                        <div className="modal-content">
                            ...
                            <div className="select_tag_area"></div>
                            <div className="modal-footer">
