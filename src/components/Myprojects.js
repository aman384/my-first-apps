...
export default class MyProjects extends Component {
    ...
    componentDidMount() {
        ...
        $('#li_my_projects').addClass('active');
        $('#li_my_projects').closest('.sidebar-submenu').show();
        $('#li_my_projects').closest('.sidebar-submenu').closest('.sidebar-dropdown').addClass('active');
        this.projectAPI()
    }
                                                ...
                                                <div className="central-meta">
                                                    <div className="frnds">
                                                        <ul className="nav nav-tabs">
                                                            <li className="nav-item"><a className="active" href="#frends" data-toggle="tab">My Projects</a> </li>
